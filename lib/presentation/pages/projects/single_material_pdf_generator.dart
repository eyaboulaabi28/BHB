...
class SingleMaterialPdfGenerator {
  ...
  Future<void> generate(BuildContext context) async {
    ...
    /// 🚨 IMPORTANT: ONLY ONE MATERIAL
    final singleList = [material];
            ...
            pw.Column(
              ...
              children: [
                ...
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    buildInfoBox( " طلبات المواد الخاصة بالمشروع موجودة في الصفحات اللاحقة.⬇️⬇️⬇️", "طلبات المواد المشروع", "Project Material Requests", arabicFont, emojiFont, icon: "📋",),
                    pw.SizedBox(width: 8),
                  ],
                ),
